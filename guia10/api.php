...
$sql = "INSERT INTO productos (nombre,descripcion,preciodecosto,preciodeventa,cantidad,fotografia) VALUES ('$nombre', '$descripcion', $preciodecosto,$preciodeventa,$cantidad,'$fotografia')";
...
$fotografia=$_GET["fotografia"];
$id=$_GET["id"];
$sql = "UPDATE productos SET nombre='$nombre', descripcion='$descripcion',preciodecosto=$preciodecosto, preciodeventa=$preciodeventa, cantidad=$cantidad, fotografia='$fotografia' WHERE id=$id";
if ($conn->query($sql) === TRUE) {
